        ...
        >
              ...
              >
                <tr>
                  <td style="padding: 0 2.5em; text-align: left">
                    <div class="text">
                      <h2>Es hat sich jemand über deine Seite gemeldet</h2>
                      <h3>Folgendes hat ${options.fullname} geschrieben</h3>
                    </div>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <table
              ...
              width="100%"
            >
              <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.05)"></tr>
              <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.05); margin-top:20px;">
                <td
                  valign="middle"
                  width="80%"
                  style="text-align: left; padding: 2.5em 2.5em"
                >
                  <div class="text">
                    <h3 style="font-size: 20px; color: black;">${options.email}</h3>
